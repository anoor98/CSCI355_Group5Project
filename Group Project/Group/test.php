        ...
        <div class="page1">
                ...
                <form action="testSubmit.php" method="POST">
                        ...
                        <div class="nav justify-content-center">
                                ...
                                Soc. Sec./Student I.D. No.<input name="Emplid" type="password" style="border:none;border-bottom:black solid 1px;">
                        ...
                        <div class="office">
                                ...
                                <div>
                                        ...
                                        <input name="currentAdd" type="text">
                                </div>
                                ...
                                <div class="nav justify-content-center">
                                        ...
                                        <input type="text" name="esignDate">
